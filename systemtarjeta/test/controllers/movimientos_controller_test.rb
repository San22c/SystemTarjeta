...
class MovimientosControllerTest < ActionController::TestCase
  ...
  test "should create movimiento" do
    assert_difference('Movimiento.count') do
      post :create, movimiento: { importe: @movimiento.importe, premio_id: @movimiento.premio_id, puntos: @movimiento.puntos, tarjetum_id: @movimiento.tarjetum_id, user_id: @movimiento.user_id }
    end
  ...
  test "should update movimiento" do
    patch :update, id: @movimiento, movimiento: { importe: @movimiento.importe, premio_id: @movimiento.premio_id, puntos: @movimiento.puntos, tarjetum_id: @movimiento.tarjetum_id, user_id: @movimiento.user_id }
    assert_redirected_to movimiento_path(assigns(:movimiento))
  end

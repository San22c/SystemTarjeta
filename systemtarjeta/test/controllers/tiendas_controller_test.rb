...
class TiendasControllerTest < ActionController::TestCase
  ...
  test "should create tienda" do
    assert_difference('Tienda.count') do
      post :create, tienda: { descripcion: @tienda.descripcion, fecha_baja: @tienda.fecha_baja, nombre: @tienda.nombre, url: @tienda.url }
    end
  ...
  test "should update tienda" do
    patch :update, id: @tienda, tienda: { descripcion: @tienda.descripcion, fecha_baja: @tienda.fecha_baja, nombre: @tienda.nombre, url: @tienda.url }
    assert_redirected_to tienda_path(assigns(:tienda))
  end

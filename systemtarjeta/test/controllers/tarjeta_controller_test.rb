...
class TarjetaControllerTest < ActionController::TestCase
  ...
  test "should create tarjetum" do
    assert_difference('Tarjetum.count') do
      post :create, tarjetum: { numref: @tarjetum.numref, puntos: @tarjetum.puntos, usuario_id: @tarjetum.usuario_id }
    end
  ...
  test "should update tarjetum" do
    patch :update, id: @tarjetum, tarjetum: { numref: @tarjetum.numref, puntos: @tarjetum.puntos, usuario_id: @tarjetum.usuario_id }
    assert_redirected_to tarjetum_path(assigns(:tarjetum))
  end

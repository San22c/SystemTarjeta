...
class PremiosControllerTest < ActionController::TestCase
  ...
  test "should create premio" do
    assert_difference('Premio.count') do
      post :create, premio: { concepto: @premio.concepto, fecha_baja: @premio.fecha_baja, puntos: @premio.puntos, stock: @premio.stock }
    end
  ...
  test "should update premio" do
    patch :update, id: @premio, premio: { concepto: @premio.concepto, fecha_baja: @premio.fecha_baja, puntos: @premio.puntos, stock: @premio.stock }
    assert_redirected_to premio_path(assigns(:premio))
  end
